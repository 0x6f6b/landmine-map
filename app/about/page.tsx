  ...
  return (
    <div className="flex flex-col min-h-[100dvh]">
      ...
      <section className="w-full px-24 pt-8 md:pt-16 lg:pt-24 border-t">
        <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl xl:text-[3.4rem] 2xl:text-[3.75rem] text-center">
          About Us
        </h1>
      </section>
      <section className="w-full py-6 md:py-12 lg:py-16 flex justify-center">
        <div className="grid items-start sm:max-w-6xl sm:grid-cols-2 md:gap-12 lg:max-w-7xl lg:grid-cols-3 text-center gap-6">
          <div className="bg-gray-100 p-4 rounded grid h-full">
            <h2 className="font-bold tracking-tighter text-3xl">Our History</h2>
            <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
              We were founded in 2024 with the goal of making Cambodia a safer
              place.
            </p>
          </div>
          <div className="bg-gray-100 p-4 rounded grid h-full">
            <h2 className="font-bold tracking-tighter text-3xl">Our Team</h2>
            <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
              We are a dedicated team of 6 who are passionate about our mission
              and each bring unique skills to the table.
            </p>
          </div>
          <div className="bg-gray-100 p-4 rounded grid h-full">
            ...
            <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
              If you would like to contribute to our cause, consider reporting a
              landmine location with our platform.
            </p>
          </div>
        </div>
      </section>
      <section className="w-full py-6 md:py-12 lg:py-16 flex justify-center">
        <div className="grid items-start sm:max-w-6xl sm:grid-cols-2 md:gap-12 lg:max-w-7xl lg:grid-cols-3 text-center gap-6">
          <div className="bg-gray-100 p-4 rounded grid h-full">
            <NonProfitIcon />
            <p className="max-w-[1200px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
